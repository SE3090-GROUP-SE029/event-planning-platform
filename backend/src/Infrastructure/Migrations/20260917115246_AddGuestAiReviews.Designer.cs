...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260917115246_AddGuestAiReviews")]
    partial class AddGuestAiReviews
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("GuestAiReviews", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_GuestAiReviews_Result", "(\"Status\" = 'COMPLETED' AND \"Recommendation\" IS NOT NULL AND \"Confidence\" IS NOT NULL AND \"AnalyzedAt\" IS NOT NULL AND cardinality(\"Reasons\") > 0 AND \"Model\" IS NOT NULL AND \"PromptVersion\" IS NOT NULL) OR (\"Status\" <> 'COMPLETED' AND \"Recommendation\" IS NULL AND \"Confidence\" IS NULL AND \"AnalyzedAt\" IS NULL)");
